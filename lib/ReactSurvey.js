...
var ReactSurvey = function (_Component) {
  ...
  _createClass(ReactSurvey, [{
    ...
    value: function render() {
      ...
      var boxPlusFoldStyle = _extends({}, styles.boxStyle, styles.foldedStyle);
      return _react2.default.createElement(
        "div",
        { id: "rs-parent" },
        _react2.default.createElement(
          "div",
          { style: this.state.folded ? boxPlusFoldStyle : styles.boxStyle },
          _react2.default.createElement(
            "div",
            { className: "heading" },
...
var DisplayButtons = function DisplayButtons(props) {
  return _react2.default.createElement(
    "div",
    { styles: styles.displayButtonsStyle },
